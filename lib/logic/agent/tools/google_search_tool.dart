...
class GoogleSearchTool extends AgentTool {
  ...
  @override
  String get description => 'Searches Google for a given query and returns the results';
  ...
  Future<String> execute(Map<String, dynamic> args) async {
    ...
    final List<Map<String, dynamic>> results = await GoogleSearchService.searchGoogle(query);
