...
mixin _$AvatarState {
 ...
 AvatarStatus get status; AvatarStatusAnimation get statusAnimation; double get baseOriginalWidth; double get baseOriginalHeight; double get scaleFactor; Avatar get avatar; AvatarConfig get avatarConfig; AvatarSpecials get previousSpecialsState;
...
@override
String toString() {
  return 'AvatarState(status: $status, statusAnimation: $statusAnimation, baseOriginalWidth: $baseOriginalWidth, baseOriginalHeight: $baseOriginalHeight, scaleFactor: $scaleFactor, avatar: $avatar, avatarConfig: $avatarConfig, previousSpecialsState: $previousSpecialsState)';
}
...
@useResult
$Res call({
 AvatarStatus status, AvatarStatusAnimation statusAnimation, double baseOriginalWidth, double baseOriginalHeight, double scaleFactor, Avatar avatar, AvatarConfig avatarConfig, AvatarSpecials previousSpecialsState
});
...
switch (_that) {
case _AvatarState() when $default != null:
return $default(_that.status,_that.statusAnimation,_that.baseOriginalWidth,_that.baseOriginalHeight,_that.scaleFactor,_that.avatar,_that.avatarConfig,_that.previousSpecialsState);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( AvatarStatus status,  AvatarStatusAnimation statusAnimation,  double baseOriginalWidth,  double baseOriginalHeight,  double scaleFactor,  Avatar avatar,  AvatarConfig avatarConfig,  AvatarSpecials previousSpecialsState)  $default,) {final _that = this;
switch (_that) {
case _AvatarState():
return $default(_that.status,_that.statusAnimation,_that.baseOriginalWidth,_that.baseOriginalHeight,_that.scaleFactor,_that.avatar,_that.avatarConfig,_that.previousSpecialsState);}
}
...
class _AvatarState extends AvatarState {
  const _AvatarState({this.status = AvatarStatus.initial, this.statusAnimation = AvatarStatusAnimation.initial, this.baseOriginalWidth = 0.0, this.baseOriginalHeight = 0.0, this.scaleFactor = 1.0, required this.avatar, required this.avatarConfig, this.previousSpecialsState = AvatarSpecials.onScreen}): super._();
